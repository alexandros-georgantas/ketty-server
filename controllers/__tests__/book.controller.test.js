...
describe('Book Controller', () => {
  ...
  it(`get all the available books of the system for team members of the global teams defined in getBooks filter for different orderBy cases`, async () => {})
  it(`get all the available books of the system for team members of the global teams defined in getBooks filter for different page and page sizes`, async () => {})
  it(`get user's available books based on team memberships`, async () => {})
  it(`get user's available books based on team memberships for different orderBy cases`, async () => {})
  it(`get user's available books based on team memberships for different page and page sizes`, async () => {})
  it(`returns no duplicate books for user who exists in more than one teams of the same book`, async () => {})
})
